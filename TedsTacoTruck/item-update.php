        ...
        <article>
            <div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-6">
						<form method="post" action="item-update-success.php">
                            <?php
                                $error = $success = "";
                                ...
                                if($_SERVER["REQUEST_METHOD"] == "POST"){
                                    ...
                                    if($statement1->execute()){
                                        $request = $statement1->fetchAll();
                                        $statement1->closeCursor();
                                    }else{
                                        $error = "Error finding menu item.";
                                    }
                                }
                            foreach($request as $r){
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="product" value="<?php echo $r["product"]; ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="num" class="form-control" name="price" value="<?php echo $r["price"]; ?>" required>
                                </div>
                            <?php
                                }
                            ?>
                            <input type="hidden" name="productId" value="<?php echo $r["productId"];?>">
							<div class="text-center"><button type="submit" class="btn btn-success w-100">Update</button></div>
						</form>
					</div>
				</div>
            </div>
